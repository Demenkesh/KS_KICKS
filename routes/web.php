...
Route::group(['middleware' => ['install']], function () {
	...
	// Route::post('image', 'Website\GatewayController@confirm_order'); //This route is for image upload
	Route::put('image/{type}/{id}', [App\Http\Controllers\Website\GatewayController::class, 'store']);//This route is for image upload
