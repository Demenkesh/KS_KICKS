						...
						<div class="card-body">
							...
							<div class="account_details">
							    <form action="{{ url('/update_address/'.$address->id) }}" method="post">
									...
									<div class="row">
										<div class="col-md-12">
											<input type="text" readonly name="name" value="{{ Auth::user()->name }}" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" placeholder="{{ _lang('Name') }}" required>
...
<!--									    </div> --}}-->
										...
										<div class="col-md-12">
											<input type="text" name="country" value="{{ $address->country }}" class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" placeholder="{{ _lang('country') }}" required>
										...
										<div class="col-md-12">
											<input type="text" name="state" value="{{ $address->state }}" class="form-control {{ $errors->has('state') ? 'is-invalid' : '' }}" placeholder="{{ _lang('state') }}" required>
