				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="single-banner">
						...
						<div class="content">
							...
							<a href="{{ get_trans_option('three_column_1_button_link') }}"><h2>{{ get_trans_option('three_column_1_button_text') }}</h2></a>
						</div>
					</div>
				</div>
				<!-- /End Single Banner  -->
				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="single-banner">
						...
						<div class="content">
							...
							<a href="{{ get_trans_option('three_column_2_button_link') }}"><h2>{{ get_trans_option('three_column_2_button_text') }}</h2></a>
						</div>
					</div>
				</div>
				<!-- /End Single Banner  -->
				...
				<div class="col-lg-4 col-12">
					<div class="single-banner tab-height">
						...
						<div class="content">
							...
							<a href="{{ get_trans_option('three_column_3_button_link') }}"><h2>{{ get_trans_option('three_column_3_button_text') }}</h2></a>
						</div>
					</div>
				</div>
				<!-- /End Single Banner  -->
