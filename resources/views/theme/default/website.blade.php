			...
			<div class="container">
				<div class="row">
					<div class="col-lg-5 col-md-12 col-12">
						...
						<div class="top-left">
							<ul class="list-main">
							    	<!--<a href="{{ url('') }}"><img src="https://kskick.com/public/uploads/media/logo2.png" alt="logo"style="height:2rem" class="bg-dark"></a>-->
								<li><i class="ti-headphone-alt" style="color:#1761fd"></i> {{ get_option('phone') }}</li>
								<li><i class="ti-email" style="color:#1761fd"></i> {{ get_option('email') }}</li>
							</ul>
						</div>
						<!--/ End Top Left -->
					</div>
					...
					<div class="col-lg-3 col-md-6 col-12">
						...
						<div class="single-footer links">
							...
							<ul>
								...
								<li><a href="{{ url('/contact-us') }}">{{ _lang('Contact Us') }}</a></li>
								@auth
