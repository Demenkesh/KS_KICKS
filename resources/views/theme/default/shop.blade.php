							...
							<div class="price-filter-inner">
								...
								<div class="price_slider_amount">
									<div class="label-input">
										<input type="hidden" id="amount" class="text-center" name="price" placeholder="{{ _lang('Add Your Price') }}"/>
										<P class="filter text-center">₦</P><input type="text" id="start_price"  value="0" class="filter text-center" readonly/>
										<input type="text" id="end_price" w value="{{ isset($_GET['end_price']) ? $_GET['end_price'] : get_max_price() }}" class="filter text-center" readonly/>
									</div>
								</div>
							</div>
